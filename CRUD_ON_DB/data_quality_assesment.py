...
def visualize_quality_issues(profiles):
    ...
    if missing_data:
        ...
        bars = ax1.barh(y_pos, missing_data, color="#FF0000", alpha=0.7)
    ...
    colors = ["#750000", "#C74F00", '#D69E2E', "#00928A", "#3D00C1"]
    ...
    bars = ax3.bar(table_names, row_counts, color="#280F63", alpha=0.7)
    ...
    bars = ax4.barh(table_names, completeness_scores, color="#92FFC0", alpha=0.7)
