...
df_sales['Sale ID'] = df_sales['Sale ID'].astype(int)
df_sales['Qty'] = df_sales['Qty'].astype(int)
df_sales['Unit Price'] = df_sales['Unit Price'].astype(float)
...
# Convertir tipos de datos
df_revenue['Sales'] = df_revenue['Sales'].astype(int)
df_revenue['Units'] = df_revenue['Units'].astype(int)
